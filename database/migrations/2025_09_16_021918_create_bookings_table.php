...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('bookings', function (Blueprint $table) {
            ...
            $table->foreignIdFor(App\Models\User::class, 'user_id')->nullable()->constrained()->cascadeOnDelete();

            // booking offline (receptionist_id)
            $table->foreignId('receptionist_id')->nullable()->constrained('receptionists')->cascadeOnDelete();
            ...
            $table->enum('status', ['pending', 'confirmed', 'booked', 'checked_in', 'checked_out', 'cancelled'])->default('pending');
